...
import { 
  LayoutDashboard, BookOpen, Heart, Eye, Star, TrendingUp, 
...
const Dashboard = () => {
  ...
  const stats = [
    { icon: BookOpen, label: 'Total Recipes', value: data?.totalRecipes || 0, color: 'bg-gradient-to-br from-cyan-500 to-blue-500' },
